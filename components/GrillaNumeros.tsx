...
export async function GrillaNumeros() {
    ...
    return (
        <div className="w-full max-w-[340px] sm:max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto grid grid-cols-5 sm:grid-cols-7 md:grid-cols-10 lg:grid-cols-10 gap-1.5 sm:gap-2 mt-4 px-2">
            {numeros.map((n: any) => (
